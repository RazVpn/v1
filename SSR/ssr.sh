...
Start_SSR(){
	check_pid
	wget -O /etc/init.d/ssrmu "https://raw.githubusercontent.com/RazVpn/v1/main/SSR/ssrmu"
...
Install_SSR
wget -O /usr/bin/mssr https://raw.githubusercontent.com/RazVpn/v1/main/SSR/mssr.sh && chmod +x /usr/bin/mssr
wget -O /usr/bin/ssr https://raw.githubusercontent.com/RazVpn/v1/main/SSR/ssrmu.sh && chmod +x /usr/bin/ssr
wget -O /usr/bin/add-ssr https://raw.githubusercontent.com/RazVpn/v1/main/SSR/add-ssr.sh && chmod +x /usr/bin/add-ssr
wget -O /usr/bin/del-ssr https://raw.githubusercontent.com/RazVpn/v1/main/SSR/del-ssr.sh && chmod +x /usr/bin/del-ssr
wget -O /usr/bin/renew-ssr https://raw.githubusercontent.com/RazVpn/v1/main/SSR/renew-ssr.sh && chmod +x /usr/bin/renew-ssr
