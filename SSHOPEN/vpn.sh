...
cd /etc/openvpn/
wget https://raw.githubusercontent.com/RazVpn/v1/main/SSHOPEN/vpn.zip
unzip vpn.zip
rm -f vpn.zip
...
dev tun
proto tcp
setenv FRIENDLY_NAME "RazVpn TCP"
...
dev tun
proto udp
setenv FRIENDLY_NAME "RazVpn UDP"
...
dev tun
proto tcp
setenv FRIENDLY_NAME "RazVpn SSL"
