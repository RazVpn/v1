...
[Unit]
Description=Xray Service ( %i ) By Ichikaa
Documentation=https://raw.githubusercontent.com/RazVpn/main/
...
wget -O cek-xvless "https://raw.githubusercontent.com/RazVpn/v1/main/V6/XRAY/cek-xvless.sh"
